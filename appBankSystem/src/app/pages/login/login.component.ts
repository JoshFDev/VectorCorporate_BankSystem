...
@Component({
          ...
          <ng-container *ngIf="mode === 'password'">
            <div class="field">
              <div class="input-wrap" [class.focused]="focusedField === 'password'" [class.has-value]="loginForm.get('password')?.value" [class.error]="loginForm.get('password')?.invalid && loginForm.get('password')?.touched">
                ...
                <input formControlName="password" [type]="showPassword ? 'text' : 'password'" placeholder=" " (focus)="focusedField = 'password'" (blur)="focusedField = ''" autocomplete="current-password" />
                ...
                <button type="button" class="toggle-password" (click)="showPassword = !showPassword" tabindex="-1">
                  ...
                  <svg *ngIf="showPassword" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                </button>
              </div>
            </div>
          </ng-container>
  ...
  styles: [`
    ...
    .toggle-password {
      ...
      color: #94a3b8; display: flex; align-items: center; flex-shrink: 0;
    }
